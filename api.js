...
const fileRef = 'https://api.anniekuku.com/uploads';
...
//--POST APIS--//
    ...
    router.post('/merch/create-new', upload.array('images', 3), (req, res, err) => {
        ...
        switch (req.files.length) {
            case 1:
                connection.query(query, [ req.body.item_name , `${fileRef}/${req.files[0].filename}` , null,  null,  req.body.item_quantity , 0,  req.body.item_price ,  req.body.item_category ,  req.body.item_description, req.body.item_design, req.body.item_color, req.body.item_metal, req.body.is_new_arrival, '0' ,  req.body.createdby ,  time ],  (err, result) => {
                    if (err) {
                        reconnect(connection); res.send(err)
                    } else {
                        const message = {
            ...
            case 2:
                ...
                break;
            case 3:
                connection.query(query, [ req.body.item_name ,`${fileRef}/${req.files[0].filename}` , `${fileRef}/${req.files[1].filename}`  , `${fileRef}/${req.files[2].filename}`  ,  req.body.item_quantity , 0,  req.body.item_price ,  req.body.item_category ,  req.body.item_description, req.body.item_design, req.body.item_color, req.body.item_metal, req.body.is_new_arrival, '0' ,  req.body.createdby ,  time ],  (err, result) => {
                    if (err) {
                        reconnect(connection); res.send(err)
                    } else {
                        const message = {
            ...
            if(err){
                ...
                switch (req.files.length){
                    ...
                    case 1:
                        ...
                        connection.query(update_query, [req.body.item_name, old_price, req.body.item_price, req.body.item_category, req.body.item_description, req.body.item_design, req.body.item_color, req.body.item_metal, req.body.is_new_arrival, `${fileRef}/${req.files[0].filename}`, null, null, req.body.item_id], (err, result) => {
                            if (err) {
                                reconnect(connection); res.send(err)
                            } else {
                                const message = {
                    ...
                    case 2:
                        update_query = "Update products set item_name = ?, old_price = ?, item_price = ?, item_category = ?, item_description = ?, item_design = ?, item_metal = ?, item_color = ?, is_new_arrival = ?, item_avatar = ? , item_avatar2 = ?, item_avatar3 = ? where id = ?";
                        connection.query(update_query, [req.body.item_name, old_price, req.body.item_price, req.body.item_category, req.body.item_description, req.body.item_design, req.body.item_color, req.body.item_metal, req.body.is_new_arrival, `${fileRef}/${req.files[0].filename}`, `${fileRef}/${req.files[1].filename}`, null, req.body.item_id], (err, result) => {
                            if (err) {
                                reconnect(connection); res.send(err)
                            } else {
                                const message = {
                    ...
                    case 3:
                        update_query = "Update products set item_name = ?, old_price = ?, item_price = ?, item_category = ?, item_description = ?, item_design = ?, item_metal = ?, item_color = ?, is_new_arrival = ?, item_avatar = ? , item_avatar2 = ?, item_avatar3 = ? where id = ?";
                        connection.query(update_query, [req.body.item_name, old_price, req.body.item_price, req.body.item_category, req.body.item_description, req.body.item_design, req.body.item_color, req.body.item_metal, req.body.is_new_arrival, `${fileRef}/${req.files[0].filename}`, `${fileRef}/${req.files[1].filename}`, `${fileRef}/${req.files[2].filename}`, req.body.item_id], (err, result) => {
                            if (err) {
                                reconnect(connection); res.send(err)
                            } else {
                                const message = {
    ...
    router.post('/carousel/create-new', upload.array('image', 1), (req, res, err) => {
        ...
        connection.query(query, [ `${fileRef}/${req.files[0].filename}`, req.body.main_caption, req.body.min_caption, req.body.createdby, time]  ,(err, result) => {
            if (err) {
                reconnect(connection); res.send(err)
            } else {
                const message = {
