    ...
    if (err){
        ...
        connection.query('CREATE TABLE IF NOT EXISTS products (id INT AUTO_INCREMENT PRIMARY KEY, item_name VARCHAR(255), item_avatar VARCHAR(255),item_avatar2 VARCHAR(255), item_avatar3 VARCHAR(255), old_price INT, item_price INT, item_category VARCHAR(255), item_quantity VARCHAR(255), quantity_sold VARCHAR(255),  item_description VARCHAR(255), createdby VARCHAR(255), createddate DATE)', (err, result) => {
            if (err) throw err;
        });
